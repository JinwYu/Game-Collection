...
//var db = mongojs('user:test@localhost:33423/gamedb', ['gamecollection']); //Local DB
var db = mongojs('admin:password@ds239097.mlab.com:39097/gamecollection', ['games']);  // Replace password with the real password on mLab.
var bodyParser = require('body-parser');
var jwt = require('express-jwt');
var jwks = require('jwks-rsa');

app.use(express.static(__dirname)); // Find the html, js and css-files.
